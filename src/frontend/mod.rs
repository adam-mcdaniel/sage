    ...
    match parse_frontend(code.as_ref(), filename) {
        Ok(result) => {
            ...
            let get_sp = crate::lir::ConstExpr::CoreBuiltin(crate::lir::CoreBuiltin {
                ...
                args: vec![],
                ret: crate::lir::Type::Pointer(crate::lir::Mutability::Immutable, Box::new(crate::lir::Type::Cell)),
                body: vec![
                    crate::asm::CoreOp::Push(crate::asm::SP, 1),
                ],
            });
            ...
            let get_fp = crate::lir::ConstExpr::CoreBuiltin(crate::lir::CoreBuiltin {
                ...
                ret: crate::lir::Type::Pointer(crate::lir::Mutability::Immutable, Box::new(crate::lir::Type::Cell)),
                body: vec![
                    crate::asm::CoreOp::Push(crate::asm::FP, 1),
                ],
            });
            ...
            let get_gp = crate::lir::ConstExpr::CoreBuiltin(crate::lir::CoreBuiltin {
                ...
                ret: crate::lir::Type::Pointer(crate::lir::Mutability::Immutable, Box::new(crate::lir::Type::Cell)),
                body: vec![
                    crate::asm::CoreOp::Push(crate::asm::GP, 1),
                ],
            });
            let get_fp_stack = crate::lir::ConstExpr::CoreBuiltin(crate::lir::CoreBuiltin {
                ...
                ret: crate::lir::Type::Pointer(crate::lir::Mutability::Immutable, Box::new(crate::lir::Type::Cell)),
                body: vec![
                    crate::asm::CoreOp::Push(crate::asm::FP_STACK, 1),
                ],
            });
            ...
            for ch in format!("Debug\n").chars() {
                ...
                debug_body.push(crate::asm::CoreOp::Put(crate::asm::TMP, Output::stdout_char()));
            }
